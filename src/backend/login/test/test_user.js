            ...
            request(app)
                ...
                .end((err, res) => {
                    if(err) return done(err);
                        ...
                        expect(newUser.password).to.not.be.null;
                        expect(newUser).ownProperty('salt');
                        expect(newUser.salt).to.not.be.undefined;
                        expect(newUser.salt).to.not.be.null;
            ...
            request(app)
                ...
                .end((err, res) => {
                    if(err) return done(err);
                        ...
                        expect(result).ownProperty('salt');
            ...
            request(app)
                ...
                .end((err, res) => {
                    if(err) return done(err);
                        ...
                        expect(result[0]).ownProperty('password');
                        expect(result[0].password).to.not.be.undefined;
                        expect(result[0].password).to.not.be.null;
                        expect(result[0]).ownProperty('salt');
                        expect(result[0].salt).to.not.be.undefined;
                        expect(result[0].salt).to.not.be.null;
                        ...
                        expect(result[1]).ownProperty('password');
                        expect(result[1].password).to.not.be.undefined;
                        expect(result[1].password).to.not.be.null;
                        expect(result[1]).ownProperty('salt');
                        expect(result[1].salt).to.not.be.undefined;
                        expect(result[1].salt).to.not.be.null;
